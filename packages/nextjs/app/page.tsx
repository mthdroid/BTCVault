    ...
    <div className="flex items-center flex-col grow">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 mb-3 px-4 py-1.5 rounded-full bg-secondary/10 border border-secondary/20">
            <Image
              ...
              height={18}
            />
            <span className="text-sm font-medium" style={{ color: "#5B8DEF" }}>
          ...
          <p className="text-lg opacity-70 mb-2">
            Non-custodial Bitcoin yield on{" "}
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link
              href="/bridge"
              className="btn btn-primary btn-lg text-white shadow-lg shadow-primary/20"
            >
              Bridge BTC
            </Link>
            <Link
              href="/vault"
              className="btn btn-outline border-secondary/50 text-secondary hover:bg-secondary hover:text-white btn-lg"
            >
              Enter Vault
            </Link>
      ...
      <div className="bg-container grow w-full px-8 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-sm opacity-40 mb-10">
            From native BTC to DeFi yield in 4 steps
          </p>
            ...
            {[
              {
                ...
                desc: "Connect your Xverse wallet to get both BTC and Starknet addresses in one click.",
                color: "bg-primary",
              },
              {
                step: "2",
                title: "Bridge BTC",
                desc: "Bridge native BTC to WBTC on Starknet via LayerSwap.",
                color: "bg-primary",
              },
              {
                step: "3",
                title: "Deposit WBTC",
                desc: "Deposit into the vault. The Router auto-allocates between Vesu and Ekubo.",
                color: "bg-accent",
              },
              {
                step: "4",
                title: "Earn Yield",
                desc: "Shares appreciate as yield accrues. Withdraw anytime to get WBTC + earned yield.",
                color: "bg-accent",
              },
            ].map((item) => (
              <div
                key={item.step}
                className="card-btc flex flex-col text-center items-center"
              >
                <div
                  className={`w-10 h-10 rounded-full ${item.color} text-white flex items-center justify-center text-lg font-bold mb-4`}
                >
                  {item.step}
                </div>
        ...
        <div className="max-w-4xl mx-auto mt-20">
          ...
          <p className="text-center text-sm opacity-40 mb-10">
            Automated yield optimization across two protocols
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card-btc">
              ...
              <p className="text-sm opacity-50 mb-5">
                Deposit WBTC into Vesu V2 vToken pools (ERC-4626). Earn passive
                lending yield with auto-compounding.
              </p>
        ...
        <div className="max-w-4xl mx-auto mt-20">
          ...
          <p className="text-center text-sm opacity-40 mb-10">
            The best protocols in the Starknet ecosystem
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative overflow-hidden rounded-2xl bg-base-100 border border-accent/15 p-6 flex flex-col items-center justify-center text-center hover:border-accent/40 hover:shadow-xl hover:shadow-accent/5 transition-all"
            >
              ...
              <span className="text-xs opacity-30 mt-1 relative z-10">
                L2 Network
              </span>
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative overflow-hidden rounded-2xl bg-base-100 border border-primary/15 p-6 flex flex-col items-center justify-center text-center hover:border-primary/40 hover:shadow-xl hover:shadow-primary/5 transition-all"
            >
