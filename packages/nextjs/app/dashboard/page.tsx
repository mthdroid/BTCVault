  ...
  if (!isConnected) {
    return (
      <div className="flex flex-col items-center justify-center grow pt-20">
        ...
        <p className="opacity-50 mb-6 text-sm">Connect your wallet to view the dashboard</p>
        <CustomConnectButton />
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center grow pt-10 px-4">
      <div className="max-w-5xl w-full">
        ...
        <p className="opacity-50 text-sm mb-8">Vault overview and strategy performance</p>

        {/* Top Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          <div className="bg-base-100 rounded-2xl shadow-sm p-5">
            <p className="text-xs opacity-40 mb-1">TVL</p>
            <p className="text-2xl font-bold">{tvl}</p>
            <p className="text-xs opacity-40">sats</p>
          </div>
          <div className="bg-base-100 rounded-2xl shadow-sm p-5">
            <p className="text-xs opacity-40 mb-1">Vault APY</p>
            <p className="text-2xl font-bold text-success">{vaultApyStr}%</p>
          </div>
          <div className="bg-base-100 rounded-2xl shadow-sm p-5">
            <p className="text-xs opacity-40 mb-1">Vesu APY</p>
            <p className="text-2xl font-bold">{vesuAPY}%</p>
          </div>
          <div className="bg-base-100 rounded-2xl shadow-sm p-5">
            <p className="text-xs opacity-40 mb-1">Ekubo APY</p>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs opacity-40">APY: {vesuAPY}%</p>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs opacity-40">APY: {ekuboAPY}%</p>
                </div>
              </div>
            </div>

            <div className="border-t border-base-200 mt-4 pt-3 flex justify-between text-xs opacity-40">
          ...
          <div className="bg-base-100 rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between">
                <span className="opacity-50 text-sm">Vault Shares</span>
                <span className="font-semibold">{userSharesStr}</span>
              </div>
              <div className="flex justify-between">
                <span className="opacity-50 text-sm">Current Value</span>
                <span className="font-semibold">{userAssetsStr} sats</span>
              </div>
              <div className="flex justify-between">
                <span className="opacity-50 text-sm">Total Vault Shares</span>
          ...
          <div className="flex flex-col items-center">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3 w-full items-center text-center text-sm">
              ...
              <div className="bg-primary/10 rounded-xl p-4 border border-primary/20">
                ...
                <p className="text-xs opacity-40">ERC-4626 shares</p>
              </div>
              <div className="flex items-center justify-center">
                <span className="text-primary font-bold">&rarr;</span>
              </div>
              <div className="flex flex-col gap-2">
                <div className="bg-primary/5 rounded-xl p-3 border border-primary/10">
                  ...
                  <p className="text-xs opacity-40">Lending yield</p>
                </div>
                <div className="bg-accent/5 rounded-xl p-3 border border-accent/10">
                  <p className="font-bold text-xs">Ekubo Strategy</p>
                  <p className="text-xs opacity-40">LP fees</p>
                </div>
              </div>
            </div>
            <div className="mt-3 text-xs opacity-30">
