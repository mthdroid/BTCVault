  ...
  return (
    <div>
      <label
        ...
        className="rounded-[18px] btn-sm font-bold px-5 bg-btn-wallet py-2 cursor-pointer text-sm"
      >
        <span>Connect</span>
      </label>
      <input
                ...
                <div className="flex flex-col pb-[20px] justify-end gap-3">
                  <div className="h-[300px] overflow-y-auto flex w-full flex-col gap-2">
                    {burnerAccounts.map((burnerAcc, ix) => (
                      ...
                      >
                        <button
                          className={`hover:bg-base-200 border rounded-xl text-neutral py-[8px] pl-[10px] pr-16 flex items-center gap-4 ${isDarkMode ? "border-[#40444F]" : "border-base-300"}`}
